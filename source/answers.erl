...
get_all() ->
	[
		...
		{problem, 51, solution, not_available},
		{problem, 52, solution, 142857},
		{problem, 53, solution, 4075},
		{problem, 54, solution, not_available},
		{problem, 55, solution, 249},
		{problem, 56, solution, 972},
		{problem, 57, solution, 153},
		{problem, 58, solution, 26241},
		{problem, 59, solution, 107359},
		
		{problem, 60, solution, not_available},
		{problem, 61, solution, not_available},
		{problem, 62, solution, not_available},
		{problem, 63, solution, 49},
		{problem, 64, solution, not_available},
		{problem, 65, solution, not_available},
		{problem, 66, solution, not_available},
		...
		{problem, 77, solution, not_available},
		{problem, 78, solution, not_available},
		{problem, 79, solution, 73162890},
		
		{problem, 80, solution, not_available},
		{problem, 81, solution, not_available},
		{problem, 82, solution, not_available},
		{problem, 83, solution, not_available},
		{problem, 84, solution, not_available},
		{problem, 85, solution, not_available},
		{problem, 86, solution, not_available},
		{problem, 87, solution, not_available},
		{problem, 88, solution, not_available},
		{problem, 89, solution, not_available},
		
		{problem, 90, solution, not_available},
		{problem, 91, solution, not_available},
		{problem, 92, solution, not_available},
		{problem, 93, solution, not_available},
		{problem, 94, solution, not_available},
		{problem, 95, solution, not_available},
		{problem, 96, solution, not_available},
